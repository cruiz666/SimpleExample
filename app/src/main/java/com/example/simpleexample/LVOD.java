...
public class LVOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvod);

        MediastreamPlayerConfig config = new MediastreamPlayerConfig();
        config.src = RawResourceDataSource.buildRawResourceUri(R.raw.vod).toString();
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(LVOD.this, MainActivity.class));
    }
}
